...
export const registeredToolHandlers: Record<string, RegisteredToolHandler> = {
  ...
  get_technical_evidence: async (params, context) => required(context, 'getTechnicalEvidence')(params),
  get_price_window: async (params, context) => required(context, 'getPriceWindow')(params),
  ...
  run_technical_analysis: async (params, context) => required(context, 'runTechnicalSpecialist')(params),
